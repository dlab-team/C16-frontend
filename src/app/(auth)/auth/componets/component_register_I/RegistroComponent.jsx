...
const RegistroComponent = () => {
    ...
    const signInWithGoogle = () => {
        ...
        signInWithPopup(auth, provider).then((result) => {
            ...
            modifyData('https://c16-backend.onrender.com/api/users', 'POST', newUser).then(res => {
                if (res.completed) {
                    router.replace('/');
                } else {
    ...
    return (
        <div>
            ...
            <div className="register__input__password">
                ...
                />
                <div className="register__input__password__img" onClick={togglePasswordVisibility}>
